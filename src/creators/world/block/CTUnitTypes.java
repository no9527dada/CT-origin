...
public class CTUnitTypes{
    ...
    //mech, legacy
    public static UnitType nova, pulsar, quasar;

    //legs
    public static UnitType corvus, atrax,
    merui, cleroi, anthicus,
    tecta, collaris;

    //legs, legacy
    public static UnitType spiroct, arkyid, toxopid;

    //air
    public static UnitType flare, eclipse, horizon, zenith, antumbra,
    avert, obviate;
    ...
    //air, legacy
    public static UnitType alpha, beta, gamma;

    //naval
    public static UnitType risso, minke, bryde, sei, omura, retusa, oxynoe, cyerce, aegires, navanax;

    public static class CTUnitType extends UnitType{
        public CTUnitType(String name, String MDTName) {
            super(name);
    ...
    public static void load(){
        ...
        dagger = new CTUnitType("dagger", "dagger"){{
            speed = 0.5f;
            hitSize = 8f;
            health = 150;
        ...
        fortress = new CTUnitType("fortress","fortress"){{
            speed = 0.43f;
            hitSize = 13f;
            rotateSpeed = 3f;
            targetAir = false;
        ...
        scepter = new CTUnitType("scepter","scepter"){{
            //controller = CTUnitTypes.scepter.//controller;
        ...
        reign = new CTUnitType("reign","reign"){{
            //controller = CTUnitTypes.reign.//controller;
        ...
        pulsar = new CTUnitType("pulsar","pulsar"){{
        ...
        quasar = new CTUnitType("quasar","quasar"){{
        ...
        corvus = new CTUnitType("corvus","corvus"){{
        ...
        crawler = new CTUnitType("crawler","crawler"){{
        ...
        atrax = new CTUnitType("atrax","atrax"){{
        ...
        spiroct = new CTUnitType("spiroct","spiroct"){{
        ...
        arkyid = new CTUnitType("arkyid","arkyid"){{
        ...
        toxopid = new CTUnitType("toxopid","toxopid"){{
        ...
        flare = new CTUnitType("flare","flare"){{
            //controller = CTUnitTypes.flare.//controller;
            mineTier = 2; 
            mineSpeed = 2.0f;
            speed = 2.7f;
            accel = 0.08f;
        ...
        horizon = new CTUnitType("horizon","horizon"){{
            //controller = CTUnitTypes.horizon.//controller;
            mineTier = 3; 
            mineSpeed = 3;
            health = 340;
            speed = 1.65f;
        ...
        zenith = new CTUnitType("zenith","zenith"){{
            //controller = CTUnitTypes.zenith.//controller;
            mineTier = 4; 
            mineSpeed = 3;
            health = 700;
            speed = 1.7f;
        ...
        antumbra = new CTUnitType("antumbra","antumbra"){{
            //controller = CTUnitTypes.antumbra.//controller;
        ...
        eclipse = new CTUnitType("eclipse","eclipse"){{
            //controller = CTUnitTypes.eclipse.//controller;
        ...
        mono = new CTUnitType("mono","mono"){{
            //controller = CTUnitTypes.mono.//controller;
        ...
        poly = new CTUnitType("poly","poly"){{
            //controller = CTUnitTypes.poly.//controller;
        ...
        mega = new CTUnitType("mega","mega"){{
            //controller = CTUnitTypes.mega.//controller;
        ...
        quad = new CTUnitType("quad","quad"){{
            //controller = CTUnitTypes.quad.//controller;
        ...
        oct = new CTUnitType("oct","oct"){{
            //controller = CTUnitTypes.oct.//controller;
        ...
        risso = new CTUnitType("risso","risso"){{
        ...
        minke = new CTUnitType("minke","minke"){{
        ...
        bryde = new CTUnitType("bryde","bryde"){{
        ...
        omura = new CTUnitType("omura","omura"){{
        ...
        retusa = new CTUnitType("retusa","retusa"){{
        ...
        oxynoe = new CTUnitType("oxynoe","oxynoe"){{
        ...
        cyerce = new CTUnitType("cyerce","cyerce"){{
        ...
        aegires = new CTUnitType("aegires","aegires"){{
        ...
        navanax = new CTUnitType("navanax","navanax"){{
