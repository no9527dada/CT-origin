...
public class PowerNetTower extends PowerBlock {
    ...
    public static final float Z_POWER_NET_EFFECT = 26f;
    public float range;
    private Color baseColor =  Color.valueOf("7ffffd");
    ...
    public static class DrawPowerNet extends DrawBlock {
        ...
        public static final Color DEFAULT_MAX_COLOR = Color.valueOf("7ffffd");
