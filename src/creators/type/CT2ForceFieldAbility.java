...
public class CT2ForceFieldAbility extends Ability {
    /** Shield radius. */
    ...
    private static CT2ForceFieldAbility paramField;
    ...
    public CT2ForceFieldAbility(float radius, float regen, float max, float cooldown){
        this.radius = radius;
        this.regen = regen;
        this.max = max;
