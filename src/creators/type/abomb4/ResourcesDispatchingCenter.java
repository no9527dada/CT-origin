...
public class ResourcesDispatchingCenter extends StorageBlock {
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid) {
        ...
        if (!DsGlobal.techDsAvailable()) {
            this.drawPlaceText(CTLIB.getMessage("msg", "dimensionCoreRequired"), x, y, valid);
            return;
        }
    ...
    public void load() {
        super.load();
        topRegion = CTLIB.loadRegion("resources-dispatching-center-top");
        bottomRegion = CTLIB.loadRegion("resources-dispatching-center-bottom");
        rotatorRegion = CTLIB.loadRegion("resources-dispatching-center-rotator");
    }
