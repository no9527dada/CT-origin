...
// exports.YunLuo =
//     (() => {
//         const a = new UnitType('YunLuo');
//         a.constructor = prov(() => extend(UnitTypes.flare.constructor.get().class, {
//             draw(unit) {
//                 this.super$draw(unit);

//                 Draw.rect(Core.atlas.find("creators-YunLuo-1"), unit.x + Angles.trnsx(unit.rotation, 30, 0), unit.y + Angles.trnsy(unit.rotation, 30, 0), Time.time * 2);
//             }        
...
const z1111 = extendContent(UnitType, "YunLuo", {
    draw(unit) {
        this.super$draw(unit);
