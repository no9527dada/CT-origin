...
//const a =  extendContent(UnitType, "nai1",{});
exports.nai1 =
    (() => {
        const a = new UnitType('nai1');
        a.defaultController = prov(() => new DefenderAI());
        a.speed = 1.5;
        a.drag = 0.4;
        a.hitSize = 6;
        a.rotateSpeed = 3;
...
exports.nai4 =
    (() => {
        ...
        a.abilities.add(
            (() => {
                const w = new EnergyFieldAbility(5, 1 * 30, 17 * 8)//(damage, reload, range)给别的单位(龙王那种范围电弧的治疗)
