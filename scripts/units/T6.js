...
const T6rishi = new UnitType("T6rishi");
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creators-T6wangzuo3");
        w.top = false;
        w.mirror = false;//镜像
        w.y = -10;
        w.x = 35;
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creators-T6wangzuo4");
        w.top = false;
        w.mirror = false;//镜像
        w.y = -10;
        w.x = -35;
