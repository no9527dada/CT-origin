...
function kuangjiAI() {
	var mineItems = Seq.with(F.fi("jin"), F.fi("jingliantai"), F.fi("shiying"),Items.copper,Items.lead,Items.thorium,Items.titanium,)
	//,Items.copper,Items.lead,Items.coal,Items.sand,Items.scrap,Items.thorium,Items.titanium,
	var tpxp = true
	var mining = true
