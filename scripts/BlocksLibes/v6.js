 ...
 */
 const defineMultiCrafter = function (originConfig) {
    ...
    block = new JavaAdapter(Block, {
        ...
        setStats() {
            ...
            this.stats.add(Stat.output, new JavaAdapter(StatValue, {
                display(table){
                    ...
                    // table.row();
                    // if (config.noParallelAffect) {
                    //     table.add(/*lib.getMessage('stat', 'multiCrafterNoParallelAffect')*/"1");
                    // } else {
                    //     table.add(/*lib.getMessage('stat', 'multiCrafterHaveParallelAffect')*/"2");
                    //     table.row();
                    //     table.add(/*lib.getMessage('stat', 'multiCrafterParallelEffect', [config.parallelEffectUp])*/"3");
                    // }
        ...
        setBars() {
            ...
            //const liquids = new JavaAdapter(dumpLiquids.concat(inputLiquids));
            const liquids = new Seq(dumpLiquids.concat(inputLiquids)).asSet();
...
exports.abomb4GC = defineMultiCrafter;
    ...
    plans: [
        {
            consume: {
                ...
                liquids: [
                    { liquid: Liquids.slag, amount: 122 },
                ],
            },
            output: {
                items: [
...
//----------------------------------------------------------
// f.outputsPower = false;
// const g = defineMultiCrafter({
//     name: 'discard-1',//液体打包
...
//     ]
// });
// g.outputsPower = false;
// const h = defineMultiCrafter({
//     name: 'discard-2',//液体解包
//     noParallelAffect: false,//false,
//     itemCapacity: 0,
//     liquidCapacity: 0,
