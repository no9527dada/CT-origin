...
const blockType = extendContent(ForceProjector, "jianshangyi", {});//减伤仪
...
blockType.consumes.power(1200 / 60);
...
blockType.consumes.item(items.monengjing1).booster = true
...
lib.setBuildingSimple(blockType, ForceProjector.ForceBuild, {
    ...
    drawShield() {
        var COLOR = new Color.valueOf("63e0f5");
        var COLOR2 = new Color.valueOf("63e0f5");
        var x = this.x;
        var y = this.y;
        var hit = this.hit;
        if (!this.broken) {
