...
const LB = extendContent(LiquidExtendingBridge, "wanxiangqiao", {
...
lib.setBuildingSimple(LB, LiquidExtendingBridge.LiquidExtendingBridgeBuild, {
    ...
    draw(){
        //this.super$draw();
        Draw.rect(Core.atlas.find("creators-wanxiangqiao"),this.x,this.y);
        Draw.z(Layer.power);
        var bridgeRegion = Core.atlas.find("creators-wanxiangqiao-bridge");
        var endRegion = Core.atlas.find("creators-wanxiangqiao-end");
