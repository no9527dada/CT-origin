...
core.outputsPower = true;
core.size = 6;
core.hasItems = true;
core.unloadable = true;
core.breakable = true;
core.rebuildable = false;
core.unitType = Dw.gammaSplus
core.health = 12000;
...
//lib.addToResearch(core, { parent: Blocks.coreNucleus.name, });
exports.WJcore = core;
...
block.consumes.powerCond(100, boolf(b => b.getReadyLaunch()));
