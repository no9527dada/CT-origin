...
const DefenderHealAI9527 = (shotUnit, findBuild, hasPower) => {
...
exports.DefenderHealAI9527 = DefenderHealAI9527;

const Firefighter9527 = (retreatDst, fleeRange, retreatDelay) => {
    var avoid = null;
    var retreatTimer = 0;
    return extend(AIController, {
        updateTargeting(){
            ...
            result = Groups.bullet.intersect(this.unit.x - realRange, this.unit.y - realRange, realRange*2, realRange*2).min(b => b.type == CreatorsBullets.fireball, b => b.dst2(this.unit.x, this.unit.y));
            if(result != null){
                var enemyBuild = null;
...
exports.Firefighter9527 = Firefighter9527;