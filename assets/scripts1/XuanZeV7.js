    ...
    this.buildConfiguration = function(table) {
        ...
        for(var i = 0; i < recLen; i++) {
            (function(i, that) {
                ...
                var button = table.button(Tex.whiteui, Styles.clearTogglei, 40, () => that.configure(button.isChecked() ? i : -1)).group(group).get();
...
module.exports = {
    MultiCrafter1(Type, EntityType, name, recipes, def, ExtraEntityDef) {
