...
const { fanghuyi } = require('BlocksLibes/fanghuyi')
...
NaMeiXing.techTree = TechTree.nodeRoot(Core.bundle.format("creators.GThree"), CTBlocks.coreShard, true, run(() => {
    ...
    lib.addToResearch(fanghuyi, {//防护仪
        parent: geshangyi.name,
        objectives: Seq.with(
            new Objectives.Research(origin_unitsT6),//研究T6孵化器
            new Objectives.SectorComplete(Maps87),//占领-奇异空间
        ),
    });
